...
SENTIMENT_AVAILABLE = False  # Forex Factory sentiment analysis removed
...
class EnhancedAnalysisEngine:
    ...
    async def _get_sentiment_analysis(self, pair: str) -> Dict[str, Any]:
        """Sentiment analysis removed - Forex Factory no longer available"""
        return {'sentiment_score': 0, 'sentiment_direction': 'Neutral', 'unavailable': True}
    ...
    async def _get_calendar_impact(self, pair: str) -> Dict[str, Any]:
        """Economic calendar impact removed - Forex Factory no longer available"""
        return {'relevant_events': [], 'impact_score': 0, 'unavailable': True}
